...
# An Oracle for an XTZ-USD price backed by Harbinger. This oracle is suitable
# for sandbox usage.
...
class SandboxOracleContract(sp.Contract):
    # Initialize a new SandboxOracleContract contract.
    #
    # Parameters:
...
if __name__ == "__main__":
    ...
    sp.add_compilation_target("sandbox-oracle", SandboxOracleContract())
