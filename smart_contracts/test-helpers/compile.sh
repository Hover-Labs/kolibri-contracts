...
CONTRACTS_ARRAY=(mock-oven-proxy            fake-harbinger            dummy-contract    mock-minter)
INVOCATION_ARRAY=("MockOvenProxyContract()" "FakeHarbingerContract()" "DummyContract()" "MockMinterContract()")
