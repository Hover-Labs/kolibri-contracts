...
class Contract(sp.Contract):
  def __init__(self):
    self.init(borrowedTokens = 1, interestIndex = 3, isLiquidated = True, ovenProxyContractAddress = sp.contract_address(Contract0), owner = sp.address('tz1S8MNvuFEUsWgjHvi3AxibRBf388NhT1q2'), stabilityFeeTokens = 2)
