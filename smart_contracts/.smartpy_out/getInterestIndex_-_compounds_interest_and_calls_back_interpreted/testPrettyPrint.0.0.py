...
class Contract(sp.Contract):
  def __init__(self):
    self.init(collateralizationPercentage = 200000000000000000000, devFundSplit = 100000000000000000, developerFundContractAddress = sp.address('tz1R6Ej25VSerE3MkSoEEeBjKHCDTFbpKuSX'), governorContractAddress = sp.address('tz1abmz7jiCV2GH2u81LRrGgAFFgvQgiDiaf'), interestIndex = 1000000000000000000, lastInterestIndexUpdateTime = sp.timestamp(0), liquidationFeePercent = 80000000000000000, liquidityPoolContractAddress = sp.address('tz3QSGPoRp3Kn7n3vY24eYeu3Peuqo45LQ4D'), ovenProxyContractAddress = sp.address('tz1c461F8GirBvq5DpFftPoPyCcPR7HQM6gm'), privateOwnerLiquidationThreshold = 20000000000000000000, stabilityFee = 1000000000000000000, stabilityFundContractAddress = sp.address('tz1W5VkdB5s7ENMESVBtwyt9kyvLqPcUczRT'), tokenContractAddress = sp.address('tz1cYufsxHXJcvANhvS55h3aY32a9BAFB494'))
  ...
  def updateContracts(self, params):
    ...
    sp.verify(sp.sender == self.data.governorContractAddress, message = 4)
    match_pair_458_fst, match_pair_458_snd = sp.match_tuple(params, names = [ "match_pair_458_fst", "match_pair_458_snd" ])
    match_pair_459_fst, match_pair_459_snd = sp.match_tuple(match_pair_458_snd, names = [ "match_pair_459_fst", "match_pair_459_snd" ])
    ...
    self.data.governorContractAddress = match_pair_458_fst
    self.data.tokenContractAddress = match_pair_459_fst
    self.data.ovenProxyContractAddress = match_pair_460_fst
    self.data.stabilityFundContractAddress = match_pair_461_fst
    self.data.developerFundContractAddress = match_pair_461_snd
