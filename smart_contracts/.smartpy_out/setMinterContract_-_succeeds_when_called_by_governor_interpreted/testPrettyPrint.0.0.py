...
class Contract(sp.Contract):
  def __init__(self):
    self.init(borrowParams = sp.none, governorContractAddress = sp.address('tz1harbiBBB9smBiDY7fV6DYpVm5aZD7HT98'), liquidateParams = sp.none, minterContractAddress = sp.address('tz1UUgPwikRHW1mEyVZfGYy6QaxrY6Y7WaG5'), oracleContractAddress = sp.address('tz1P2Po7YM526ughEsRbY4oR9zaUPDZjxFrb'), ovenRegistryContractAddress = sp.address('tz1hAYfexyzPGG6RhZZMpDvAHifubsbb6kgn'), pauseGuardianContractAddress = sp.address('tz1LLNkQK4UQV6QcFShiXJ2vT2ELw449MzAA'), paused = False, state = 0, withdrawParams = sp.none)
