...
class Contract(sp.Contract):
  def __init__(self):
    self.init(borrowParams = sp.none, governorContractAddress = sp.address('tz1abmz7jiCV2GH2u81LRrGgAFFgvQgiDiaf'), liquidateParams = sp.none, minterContractAddress = sp.contract_address(Contract0), oracleContractAddress = sp.address('tz1P2Po7YM526ughEsRbY4oR9zaUPDZjxFrb'), ovenRegistryContractAddress = sp.address('tz1hAYfexyzPGG6RhZZMpDvAHifubsbb6kgn'), pauseGuardianContractAddress = sp.address('tz1LLNkQK4UQV6QcFShiXJ2vT2ELw449MzAA'), paused = False, state = 3, withdrawParams = sp.none)
