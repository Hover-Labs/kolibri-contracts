...
class Contract(sp.Contract):
  def __init__(self):
    self.init(governorContractAddress = sp.address('tz1abmz7jiCV2GH2u81LRrGgAFFgvQgiDiaf'), ovenFactoryContractAddress = sp.address('tz1irJKkXS2DBWkU1NnmFQx1c1L7pbGg4yhk'), ovenMap = {})
