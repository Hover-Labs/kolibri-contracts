...
class Contract(sp.Contract):
  def __init__(self):
    self.init(collateralizationPercentage = 200000000000000000000, devFundSplit = 100000000000000000, developerFundContractAddress = sp.address('tz1R6Ej25VSerE3MkSoEEeBjKHCDTFbpKuSX'), governorContractAddress = sp.address('tz1abmz7jiCV2GH2u81LRrGgAFFgvQgiDiaf'), interestIndex = 1100000000000000000, lastInterestIndexUpdateTime = sp.timestamp(0), liquidationFeePercent = 80000000000000000, liquidityPoolContractAddress = sp.address('tz3QSGPoRp3Kn7n3vY24eYeu3Peuqo45LQ4D'), ovenProxyContractAddress = sp.address('tz1c461F8GirBvq5DpFftPoPyCcPR7HQM6gm'), privateOwnerLiquidationThreshold = 20000000000000000000, stabilityFee = 100000000000000000, stabilityFundContractAddress = sp.address('tz1W5VkdB5s7ENMESVBtwyt9kyvLqPcUczRT'), tokenContractAddress = sp.address('tz1cYufsxHXJcvANhvS55h3aY32a9BAFB494'))
