...
class Contract(sp.Contract):
  def __init__(self):
    self.init(clientCallback = sp.none, governorContractAddress = sp.address('tz1abmz7jiCV2GH2u81LRrGgAFFgvQgiDiaf'), harbingerContractAddress = sp.address('tz1TDSmoZXwVevLTEvKCTHWpomG76oC9S2fJ'), maxDataDelaySec = 1800, state = 1)
