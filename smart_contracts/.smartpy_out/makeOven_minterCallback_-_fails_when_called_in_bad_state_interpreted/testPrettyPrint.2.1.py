...
class Contract(sp.Contract):
  def __init__(self):
    self.init(governorContractAddress = sp.address('tz1abmz7jiCV2GH2u81LRrGgAFFgvQgiDiaf'), initialDelegate = sp.some(sp.key_hash('tz1abmz7jiCV2GH2u81LRrGgAFFgvQgiDiaf')), makeOvenOwner = sp.some(sp.address('tz1S8MNvuFEUsWgjHvi3AxibRBf388NhT1q2')), minterContractAddress = sp.address('tz1UUgPwikRHW1mEyVZfGYy6QaxrY6Y7WaG5'), ovenProxyContractAddress = sp.address('tz1c461F8GirBvq5DpFftPoPyCcPR7HQM6gm'), ovenRegistryContractAddress = sp.address('tz1hAYfexyzPGG6RhZZMpDvAHifubsbb6kgn'), state = 0)
