...
class Contract(sp.Contract):
  def __init__(self):
    self.init(collateralizationPercentage = 200000000000000000000, devFundSplit = 100000000000000000, developerFundContractAddress = sp.contract_address(Contract3), governorContractAddress = sp.address('tz1abmz7jiCV2GH2u81LRrGgAFFgvQgiDiaf'), interestIndex = 1000000000000000000, lastInterestIndexUpdateTime = sp.timestamp(1601871456), liquidationFeePercent = 80000000000000000, liquidityPoolContractAddress = sp.contract_address(Contract4), ovenProxyContractAddress = sp.contract_address(Contract0), privateOwnerLiquidationThreshold = 25000000000000000000, stabilityFee = 0, stabilityFundContractAddress = sp.contract_address(Contract2), tokenContractAddress = sp.contract_address(Contract1))
