...
class Contract(sp.Contract):
  def __init__(self):
    self.init(borrowedTokens = 0, interestIndex = 1000000000000000000, isLiquidated = False, ovenProxyContractAddress = sp.contract_address(Contract7), owner = sp.contract_address(Contract12), stabilityFeeTokens = 0)
