...
class Contract(sp.Contract):
  def __init__(self):
    self.init(administratorContractAddress = sp.contract_address(Contract1), governorContractAddress = sp.address('tz1abmz7jiCV2GH2u81LRrGgAFFgvQgiDiaf'), tokenContractAddress = sp.address('tz1cYufsxHXJcvANhvS55h3aY32a9BAFB494'))
