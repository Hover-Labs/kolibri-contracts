...
class Contract(sp.Contract):
  def __init__(self):
    self.init(borrowedTokens = 0, interestIndex = 1000000000000000000, isLiquidated = False, ovenProxyContractAddress = sp.contract_address(Contract0), owner = sp.address('tz1S8MNvuFEUsWgjHvi3AxibRBf388NhT1q2'), stabilityFeeTokens = 0)
