...
class Contract(sp.Contract):
  def __init__(self):
    self.init_type(sp.TRecord(harbingerAsset = sp.TString, harbingerUpdateTime = sp.TTimestamp, harbingerValue = sp.TNat).layout(("harbingerAsset", ("harbingerUpdateTime", "harbingerValue"))))
    self.init(harbingerAsset = 'XTZ-USD',
              harbingerUpdateTime = sp.timestamp(0),
              harbingerValue = 2000000)
