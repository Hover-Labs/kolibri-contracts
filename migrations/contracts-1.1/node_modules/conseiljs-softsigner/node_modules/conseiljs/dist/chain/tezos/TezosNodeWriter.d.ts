...
export declare namespace TezosNodeWriter {
    ...
    function sendOperation(server: string, operations: TezosP2PMessageTypes.Operation[], signer: Signer): Promise<TezosTypes.OperationResult>;
    ...
    function sendTransactionOperation(server: string, signer: Signer, keyStore: KeyStore, to: string, amount: number, fee: number): Promise<TezosTypes.OperationResult>;
    function sendDelegationOperation(server: string, signer: Signer, keyStore: KeyStore, delegate: string | undefined, fee?: number): Promise<TezosTypes.OperationResult>;
    function sendUndelegationOperation(server: string, signer: Signer, keyStore: KeyStore, fee?: number): Promise<TezosTypes.OperationResult>;
    function sendContractOriginationOperation(server: string, signer: Signer, keyStore: KeyStore, amount: number, delegate: string | undefined, fee: number, storageLimit: number, gasLimit: number, code: string, storage: string, codeFormat?: TezosTypes.TezosParameterFormat): Promise<TezosTypes.OperationResult>;
    ...
    function sendKeyRevealOperation(server: string, signer: Signer, keyStore: KeyStore, fee?: number): Promise<TezosTypes.OperationResult>;
