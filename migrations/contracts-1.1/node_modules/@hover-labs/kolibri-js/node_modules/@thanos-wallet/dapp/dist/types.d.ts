...
export declare type ThanosDAppRequest = ThanosDAppGetCurrentPermissionRequest | ThanosDAppPermissionRequest | ThanosDAppOperationRequest | ThanosDAppSignRequest | ThanosDAppBroadcastRequest;
export declare type ThanosDAppResponse = ThanosDAppGetCurrentPermissionResponse | ThanosDAppPermissionResponse | ThanosDAppOperationResponse | ThanosDAppSignResponse | ThanosDAppBroadcastResponse;
...
export interface ThanosDAppGetCurrentPermissionRequest extends ThanosDAppMessageBase {
    type: ThanosDAppMessageType.GetCurrentPermissionRequest;
}
export interface ThanosDAppGetCurrentPermissionResponse extends ThanosDAppMessageBase {
...
export declare type ThanosDAppPermission = {
    rpc: string;
    pkh: string;
    publicKey: string;
} | null;
export declare type ThanosDAppNetwork = "mainnet" | "delphinet" | "edo2net" | "carthagenet" | "sandbox" | {
    name: string;
    rpc: string;
};
