...
(function (TezosNodeReader) {
    ...
    function getBlockAtOffset(server, offset, chainid = 'main') {
        return __awaiter(this, void 0, void 0, function* () {
            if (offset <= 0) {
                return getBlock(server);
            }
            const head = yield getBlock(server);
            return performGetRequest(server, `chains/${chainid}/blocks/${Number(head['header']['level']) - offset}`).then(json => { return json; });
        });
    }
    TezosNodeReader.getBlockAtOffset = getBlockAtOffset;
    ...
    function getAccountManagerForBlock(server, block, accountHash, chainid = 'main') {
        return __awaiter(this, void 0, void 0, function* () {
            const key = yield performGetRequest(server, `chains/${chainid}/blocks/${block}/context/contracts/${accountHash}/manager_key`);
