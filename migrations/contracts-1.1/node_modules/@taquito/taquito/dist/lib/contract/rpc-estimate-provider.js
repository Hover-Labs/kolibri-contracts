            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        _d = [__assign({ fee: constants_1.DEFAULT_FEE.REVEAL, gasLimit: constants_1.DEFAULT_GAS_LIMIT.REVEAL, storageLimit: constants_1.DEFAULT_STORAGE_LIMIT.REVEAL }), pkh];
                        return [4 /*yield*/, this.signer.publicKey()];
