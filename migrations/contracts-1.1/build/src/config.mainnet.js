...
exports.NODE_URL = "https://rpc.tzbeta.net/";
exports.BETTER_CALL_DEV_BASE_URL = "https://api.better-call.dev/v1";
exports.OPERATION_DELAY_SECS = 40;
exports.MAX_RETRIES_FOR_CONFIRMATION_POLLING = 10;
exports.NUMBER_OF_CONFIRMATIONS = 2;
exports.coreContracts = kolibri_js_1.CONTRACTS.MAIN;
exports.GOV_PARAMS = {
    escrowAmount: new bignumber_js_1.default('3000000000000000000000'),
    voteLengthBlocks: new bignumber_js_1.default('10080'),
    blocksInTimelockForExecution: new bignumber_js_1.default('4320')
};
